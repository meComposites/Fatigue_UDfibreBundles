function [] = bundleX(n,DeltaN,N,Df,R,inputs)
...
global lnSue lnSke le leF deltaA lintact lcontrol
...
[ tau0, gamma0, dSL, GIIth, GIIctm, G, gammaN, C1, mp,  lambda,Ef ] = fproperties( X,Tf,tm,Tsl ,inputs);
...
%% This block is the scaling of the effective recovery length of level i+1 based
% on the survival probability of level i bundle
erro2=30*eps;
